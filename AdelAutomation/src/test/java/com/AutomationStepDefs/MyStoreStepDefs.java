package com.AutomationStepDefs;
...
public class MyStoreStepDefs {
	...
	public void user_enter_valid_username_and_password() throws Throwable {
		...
		driver.findElement(By.xpath("(//*[@name='email'])[1]")).sendKeys("rahmattaher@icloud.com");
		driver.findElement(By.xpath("//*[@id='passwd']")).sendKeys("rahmat007");
	...
	@Given("^user select the second dress on that current list and remember the price$")
	public void user_select_the_second_dress_on_that_current_list_and_remember_the_price() throws Throwable {
...
Assert.assertTrue("price don't match", actual.contains(expected));
	...
	@Then("^user click on the sing out button from My store and close the window$")
	public void user_click_on_the_sing_out_button_from_My_store_and_close_the_window() throws Throwable {
driver.findElement(By.xpath("(//*[contains(text(),'Sign out')])[1]")).click();
driver.close();
	}
}
//	@Then("^user click the sign in button on the right #	And user enter valid username and password$")
//	public void user_click_the_sign_in_button_on_the_right_And_user_enter_valid_username_and_password()
//			throws Throwable {
//	}
//
//	@Then("^user click on the sing out button from My store and close the wsf-with-ulindow$")
//	public void user_click_on_the_sing_out_button_from_My_store_and_close_the_wsf_with_ulindow() throws Throwable {
//	}
//
//}
